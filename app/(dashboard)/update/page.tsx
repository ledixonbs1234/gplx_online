...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        handleResetForm();
        if (sbdInputRef.current) {
          sbdInputRef.current.focus();
          sbdInputRef.current.select();
        }
      }, 1500);
                  ...
                  {searchStatus === 'idle' ? (
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <span className={`block font-extrabold leading-tight mt-1 ${searchStatus === 'not_found'
                      ...
                      {suggestions.map((suggestionData, index) => {
                        ...
                        return (
                          <div
                            ...
                            className={`px-4 py-3 text-lg font-medium cursor-pointer transition-colors flex items-center justify-between ${index === activeSuggestionIndex
